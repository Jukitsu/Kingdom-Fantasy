...
class PlayerAnimations:
    ...
    def animationPhases(self, path, duration, velocity):
        velocityValue = math.sqrt(velocity[0]**2 + velocity[1]**2)
        numberOfPhases = len(duration) 
        self.ticks[0] += velocityValue 
